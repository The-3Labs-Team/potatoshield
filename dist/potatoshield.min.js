let hiddenBody=!1,isItalianLanguage="it-IT"===navigator.language,imagesCdnUrl="https://cdn.jsdelivr.net/gh/The-3Labs-Team/js-anti-adblock@main/assets",body=document.querySelector("body");async function detectAdBlock(){let e=!1;try{var n=["uBlock","height:1px!important"],o=await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"));o.headers.get("content-length")||(e=!0);let t=await o.text();n.some(e=>t.includes(e))&&(e=!0);var i=document.createElement("div"),a=(i.id="ZAoUDSVetuRd",i.style.display="none",document.body.appendChild(i),document.getElementById("ZAoUDSVetuRd")||(e=!0),document.createElement("div"));a.id="ad-test",a.style.display="none",document.body.appendChild(a),document.getElementById("ad-test")||(e=!0)}catch(i){console.error(i),e=!0}finally{console.log("AdBlock Enabled: "+e)}return e}function showBannerAdBlock(){body.style.setProperty("overflow","hidden","important"),body.innerHTML+=`
