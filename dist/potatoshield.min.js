let hiddenBody=!1,isItalianLanguage="it-IT"===navigator.language,imagesCdnUrl="https://cdn.jsdelivr.net/gh/The-3Labs-Team/js-anti-adblock@main/assets",body=document.querySelector("body");async function detectAdBlock(){let n=!1;try{var e=["uBlock","height:1px!important"],a=await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"));a.headers.get("content-length")||(n=!0);let t=await a.text();e.some(e=>t.includes(e))&&(n=!0)}catch(e){n=!0}finally{console.log("AdBlock Enabled: "+n)}return n}function showBannerAdBlock(){body.style.overflow="hidden",body.innerHTML+=`
  ...
  `;var e=document.createElement("script");e.textContent=`
    ...
    `,body.appendChild(e)}function getRandomStyle(){let t=[{name:"width",value:"100%"},{name:"height",value:"100vh"},{name:"padding",value:"10px"},{name:"background-color",value:"rgba(0,0,0,0.68)"},{name:"position",value:"fixed"},{name:"top",value:"0"},{name:"left",value:"0"},{name:"z-index",value:"999999"},{name:"display",value:"flex"},{name:"font-family",value:"-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol"},{name:"backdrop-filter",value:"blur(5px) grayscale(100%)"}];return Array.from({length:t.length},(e,t)=>t).sort(()=>Math.random()-.5).map(e=>`${t[e].name}: ${t[e].value};`).join(" ")}function getContentFirstPage(){return`<div id="content-1" style="display: flex; padding: 30px 10px 10px; min-height: 305px;">
      ...
      </div>`}function getHowDisableButton(){return isItalianLanguage?"Come lo disattivo?":"How to disable?"}function getReturnBackButton(){return isItalianLanguage?"Indietro":"Back"}window.onload=async()=>{await detectAdBlock()&&(body.setAttribute("aria-hidden","true"),hiddenBody&&(body.innerHTML=""),showBannerAdBlock())},"undefined"!=typeof module&&void 0!==module.exports?module.exports={hiddenBody:hiddenBody,isItalianLanguage:isItalianLanguage,imagesCdnUrl:imagesCdnUrl,detectAdBlock:detectAdBlock,showBannerAdBlock:showBannerAdBlock}:window.myLibrary={hiddenBody:hiddenBody,isItalianLanguage:isItalianLanguage,imagesCdnUrl:imagesCdnUrl,detectAdBlock:detectAdBlock,showBannerAdBlock:showBannerAdBlock};