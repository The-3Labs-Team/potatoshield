async function detectAdBlock(){let n=!1;try{var e=["uBlock","height:1px!important"],i=await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"));i.headers.get("content-length")||(n=!0);let t=await i.text();e.some(e=>t.includes(e))&&(n=!0)}catch(e){n=!0}finally{console.log("AdBlock Enabled: "+n)}return n}let hiddenBody=!1,isItalianLanguage="it-IT"===navigator.language,imagesCdnUrl="https://cdn.jsdelivr.net/gh/The-3Labs-Team/js-anti-adblock@main/assets",body=document.querySelector("body");function showBannerAdBlock(){body.style.overflow="hidden",body.innerHTML+=`
