let hiddenBody=!1,isItalianLanguage="it-IT"===navigator.language,imagesCdnUrl="https://cdn.jsdelivr.net/gh/The-3Labs-Team/js-anti-adblock@main/assets",body=document.querySelector("body");async function detectAdBlock(){let n=!1;try{var e=await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js")),o=(e.headers.get("content-length")||(n=!0),(await fetch(new Request("https://www.googletagservices.com/tag/js/gpt.js"))).headers.get("content-length")||(n=!0),["uBlock","height:1px!important"]);let t=await e.text();o.some(e=>t.includes(e))&&(n=!0);var a=document.createElement("div"),i=(a.id="ad-test",a.style.display="none",document.body.appendChild(a),document.getElementById("ad-test")||(n=!0),document.createElement("div"));i.className="adsbygoogle",i.style.width="1px",i.style.height="1px",document.body.appendChild(i),0===i.offsetHeight&&(n=!0),document.body.removeChild(i)}catch(e){console.error(e),n=!0}finally{console.log("AdBlock Enabled: "+n)}return n}function hideBody(){body.setAttribute("aria-hidden","true"),hiddenBody&&(body.innerHTML="")}function showBannerAdBlock(){body.style.setProperty("overflow","hidden","important"),body.innerHTML+=getBannerAdBlockHTML();var e=document.createElement("script");e.textContent=`
  ...
  `,body.appendChild(e)}function getBannerAdBlockHTML(){return`
  ...
  `}function getRandomStyle(){let t=[{name:"width",value:"100%"},{name:"height",value:"100vh"},{name:"padding",value:"10px"},{name:"background-color",value:"rgba(0,0,0,0.68)"},{name:"position",value:"fixed"},{name:"top",value:"0"},{name:"left",value:"0"},{name:"z-index",value:"999999"},{name:"display",value:"flex"},{name:"font-family",value:"-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol"},{name:"backdrop-filter",value:"blur(5px) grayscale(100%)"}];return Array.from({length:t.length},(e,t)=>t).sort(()=>Math.random()-.5).map(e=>`${t[e].name}: ${t[e].value};`).join(" ")}function getContentFirstPage(){return`
  ...
  `}function getContentSecondPage(){return`
  ...
  `}function getHowDisableButton(){return isItalianLanguage?"Come lo disattivo?":"How to disable?"}function getReturnBackButton(){return isItalianLanguage?"Indietro":"Back"}window.onload=async()=>{await detectAdBlock()&&(hideBody(),showBannerAdBlock())};