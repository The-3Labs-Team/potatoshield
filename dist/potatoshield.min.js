let hiddenBody=!1,isItalianLanguage="it-IT"===navigator.language,imagesCdnUrl="https://cdn.jsdelivr.net/gh/The-3Labs-Team/js-anti-adblock@main/assets",body=document.querySelector("body");async function detectAdBlock(){let e=!1;try{var n=["uBlock","height:1px!important"],o=await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"));o.headers.get("content-length")||(e=!0);let t=await o.text();n.some(e=>t.includes(e))&&(e=!0);var a=document.createElement("div");a.id="ZAoUDSVetuRd",a.style.display="none",document.body.appendChild(a),e=!document.getElementById("ZAoUDSVetuRd");(await fetch(new Request("https://static.adocean.pl/_1451054334/ad.js"))).headers.get("content-length")||(e=!0)}catch(a){e=!0}finally{console.log("AdBlock Enabled: "+e)}return e}function showBannerAdBlock(){body.style.setProperty("overflow","hidden","important"),body.innerHTML+=`
